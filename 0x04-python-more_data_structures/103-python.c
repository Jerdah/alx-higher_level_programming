...
/**
 * print_python_bytes_info - Function prints information abut a Python bytes object
...
/**
 * print_python_bytes - Fucntion prints information about a Python bytes object
 * @p: Pointer to the Python bytes object
 */
